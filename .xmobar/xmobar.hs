Config {
	...
	Run Com "/bin/bash" ["-c", "~/.local/bin/get-volume.sh"]  "myvolume" 1,
        Run StdinReader
    ],
    sepChar = "%",
    alignSep = "}{",
    template = "%StdinReader% <fc=#666666>│</fc> %battery% }{ %cpu% <fc=#666666>│</fc> %memory% <fc=#666666>│</fc> %dynnetwork% <fc=#666666>│</fc> <fc=#b2b2ff>%myvolume%</fc> <fc=#666666>│</fc> %date%"
}
