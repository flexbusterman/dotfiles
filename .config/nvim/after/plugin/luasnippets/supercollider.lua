...
s("synth", {
    t({"Ndef(\\"}),
    i(1, "synth"),
    t({", Pbind(\\instrument, \\synth, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\freq, "}),
    i(2, "440"),
...
s("sine", {
    t({"Ndef(\\"}),
    i(1, "sine"),
    t({", Pbind(\\instrument, \\sine, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\freq, "}),
    i(2, "100"),
    t({", \\pan, 0));"})
}),
s("sinFb", {
    t({"Ndef(\\"}),
    i(1, "sinFb"),
    t({", Pbind(\\instrument, \\sinFb, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\freq, "}),
    i(2, "440"),
...
s("sinFbGate", {
    t({"Ndef(\\"}),
    i(1, "sinFbGate"),
    t({", Pbind(\\instrument, \\sinFbGate, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\freq, "}),
    i(2, "440"),
...
s("sinFbBp", {
    t({"Ndef(\\"}),
    i(1, "sinFbBp"),
    t({", Pbind(\\instrument, \\sinFbBp, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\pan, 0, \\freq, "}),
    i(2, "440"),
...
s("saw", {
    t({"Ndef(\\"}),
    i(1, "saw"),
    t({", Pbind(\\instrument, \\saw, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\pan, 0, \\freq, "}),
    i(2, "100"),
...
s("sawMoog", {
    t({"Ndef(\\"}),
    i(1, "sawMoog"),
    t({", Pbind(\\instrument, \\sawMoog, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\pan, 0, \\freq, "}),
    i(2, "100"),
...
s("fmOld", {
    t({"Ndef(\\"}),
    i(1, "fmOld"),
    t({", Pbind(\\instrument, \\fmOld, \\amp, 0.1, \\auxOut, 0, \\auxAmp, 0, \\freq, "}),
    i(2, "440"),
...
s("fm", {
    t({"Ndef(\\"}),
    i(1, "fm"),
    t({", Pbind(\\instrument, \\fm, \\amp, 0.2, \\mod1amp, 500, \\mod1ratio, 1, \\mod2amp, 0, \\mod2ratio, 1, \\carRatio, 1, \\freq, "}),
    i(2, "500"),
...
s("fm_algo4", {
    t({"Ndef(\\"}),
    i(1, "fm_algo4"),
    t({", Pbind(\\instrument, \\fm_algo4, \\amp_1, 1, \\amp_2, 0.5, \\amp_3, 0.5, \\amp_4, 1, \\amp_5, 0.5, \\amp_6, 0.5, \\ratio1, 1, \\ratio2, 1, \\ratio3, 1, \\ratio4, 1, \\ratio5, 1, \\ratio6, 1, \\mInd_1, 0.5, \\mInd_2, 0.5, \\mInd_3, 0.1, \\mInd_4, 0.5, \\mInd_5, 0.5, \\mInd_6, 0.5, \\fb, 0.9, \\freq, "}),
    i(2, "111"),
    t({", \\amp, 0.2));"})
}),
s("gong", {
    t({"Ndef(\\"}),
    i(1, "gong"),
    t({", Pbind(\\instrument, \\gong, \\amp, 0.2, \\freqLo, 0, \\freq, "}),
    i(2, "440"),
...
s("multiSaw", {
    t({"Ndef(\\"}),
    i(1, "multiSaw"),
    t({", Pbind(\\instrument, \\multiSaw, \\amp, 0.2, \\detune, 0.05, \\att, 0.001, \\sus, 0.03, \\rel, 2, \\gain, 1.0, \\cutoff, 600, \\rq, 1.0, \\threshold, 0.5, \\slopeBelow, 1, \\slopeAbove, 0.5, \\clampTime, 0.001, \\relaxTime, 0.1, \\pan, 0, \\auxOut, 0, \\auxAmp, 0, \\freq, "}),
    i(2, "100"),
    t({"));"})
}),
s("bd808", {
    t({"Ndef(\\"}),
    i(1, "bd808"),
    t({", Pbind(\\instrument, \\bd808, \\amp, 0.2, \\rel, 4, \\tone, 56, \\fRel, 0.6, \\punchTone, 56, \\punchRel, 0.6, \\subAmp, 0.05, \\pan, 0, \\auxOut, 0, \\auxAmp, 0));"})
}),
s("sd808", {
    t({"Ndef(\\"}),
    i(1, "sd808"),
    t({", Pbind(\\instrument, \\sd808, \\amp, 0.2, \\noiseRel, 4.2, \\attRel, 0.8, \\snappy, 0.3, \\noiseHpfFreq, 1800, \\noiseLpfFreq, 8850, \\hpfFreq, 340, \\pan, 0, \\auxOut, 0, \\auxAmp, 0));"})
}),
s("cp808", {
    t({"Ndef(\\"}),
    i(1, "cp808"),
    t({", Pbind(\\instrument, \\cp808, \\amp, 0.2, \\atRel, 0.3, \\dDelay, 0.026, \\dDecay, 6, \\dRel, 1, \\dPeak, 1, \\hpfFreq, 500, \\bpfFreq, 1062, \\bpfRq, 0.5, \\pan, 0, \\auxOut, 0, \\auxAmp, 0));"})
}),
s("lt808", {
    t({"Ndef(\\"}),
    i(1, "lt808"),
    t({", Pbind(\\instrument, \\lt808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\pan, 0, \\rel, 20, \\relCrv, -250, \\pRel, 30, \\prelCrv, -225, \\freq, "}),
    i(2, "80"),
    t({"));"})
}),
s("mt808", {
    t({"Ndef(\\"}),
    i(1, "mt808"),
    t({", Pbind(\\instrument, \\mt808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\pan, 0, \\rel, 16, \\relCrv, -250, \\fRel, 0.5, \\freq, "}),
    i(2, "120"),
    t({"));"})
}),
s("ht808", {
    t({"Ndef(\\"}),
    i(1, "ht808"),
    t({", Pbind(\\instrument, \\ht808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\pan, 0, \\rel, 11, \\relCrv, -250, \\fRel, 0.5, \\freq, "}),
    i(2, "165"),
    t({"));"})
}),
s("lc808", {
    t({"Ndef(\\"}),
    i(1, "lc808"),
    t({", Pbind(\\instrument, \\lc808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\pan, 0, \\rel, 18, \\relCrv, -250, \\pRel, 30, \\prelCrv, -225, \\fRel, 0.5, \\freq, "}),
    i(2, "165"),
    t({"));"})
}),
s("mc808", {
    t({"Ndef(\\"}),
    i(1, "mc808"),
    t({", Pbind(\\instrument, \\mc808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\rel, "}),
    i(2, "9"),
    t({", \\relCrv, -250, \\freq, "}),
    i(3, "250"),
...
s("hc808", {
    t({"Ndef(\\"}),
    i(1, "hc808"),
    t({", Pbind(\\instrument, \\hc808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\rel, "}),
    i(2, "6"),
    t({", \\relCrv, -250, \\freq, "}),
    i(3, "370"),
    t({", \\fRel, 0.5, \\frelCrv, -4, \\pan, 0));"})
...
s("rim808", {
    t({"Ndef(\\"}),
    i(1, "rim808"),
    t({", Pbind(\\instrument, \\rim808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\rel, "}),
    i(2, "0.07"),
    t({", \\relCrv, -42, \\tri1freq, "}),
    i(3, "1667"),
...
s("claves808", {
    t({"Ndef(\\"}),
    i(1, "claves808"),
    t({", Pbind(\\instrument, \\claves808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\rel, "}),
    i(2, "0.1"),
    t({", \\relCrv, -20, \\freq, "}),
    i(3, "2500"),
    t({", \\pan, 0));"})
...
s("maracas808", {
    t({"Ndef(\\"}),
    i(1, "maracas808"),
    t({", Pbind(\\instrument, \\maracas808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\rel, "}),
    i(2, "0.07"),
...
s("cowbell808", {
		t({"Ndef(\\",}),
		i(1, "cowbell808"),
		t({", Pbind(\\instrument, \\cowbell808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\pan, 0, \\attRel, 1, \\attrelCrv, -215, \\rel, 9.5, \\relCrv, -90, \\pulse1freq, "}),
		i(2, "811.16"),
...
s("hat808", {
		t({"Ndef(\\",}),
		i(1, "hat808"),
		t({", Pbind(\\instrument, \\hat808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\pan, 0, \\rel, 0.42, \\relCrv, -30, \\osc1freq, "}),
		i(2, "203.52"),
...
s("hatOpen808", {
		t({"Ndef(\\",}),
		i(1, "hatOpen808"),
		t({", Pbind(\\instrument, \\hatOpen808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\pan, 0, \\env1rel, 0.5, \\env1relCrv, -3, \\env2rel, 0.5, \\env2relCrv, -150, \\osc1freq, "}),
		i(2, "203.52"),
...
s("cymbal808", {
		t({"Ndef(\\",}),
		i(1, "cymbal808"),
		t({", Pbind(\\instrument, \\cymbal808, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\pan, 0, \\rel1, 2, \\rel1crv, -3, \\rel2, 2, \\rel2crv, -5, \\rel3, 2, \\rel3crv, -150, \\osc1freq, "}),
		i(2, "203.52"),
...
s("gverb", {
		t({"Ndef(\\"}),
		i(1, "gverb"),
		t({", Pbind(\\instrument, \\gverb, \\inamp, 1, \\roomsize, 10, \\revtime, 4, \\damping, 0.5, \\inputbw, 0.5, \\spread, 15, \\drylevel, 0, \\earlyreflevel, 0.7, \\taillevel, 0.5, \\maxroomsize, 300, \\cutoff, 20000, \\auxAmp, 0, \\out, 0, \\auxOut, 0));"})
}),
s("freeverb", {
		t({"Ndef(\\"}),
		i(1, "freeverb"),
		t({", Pbind(\\instrument, \\freeverb, \\inamp, 1, \\mix, 1, \\room, 0.95, \\damp, 0.3, \\out, 0, \\auxOut, 0, \\auxAmp, 0));"})
}),
s("serialverb", {
		t({"Ndef(\\"}),
		i(1, "serialverb"),
		t({", Pbind(\\instrument, \\serialverb, \\inamp, 1, \\feedback, 0.9, \\cutoff, 3000, \\maxDelayTime, 0.2, \\minDelayTime, 0.01, \\decayTime, 3, \\out, 0, \\auxOut, 0, \\auxAmp, 0));"})
}),
s("tank", {
		t({"Ndef(\\"}),
		i(1, "tank"),
		t({", Pbind(\\instrument, \\tank, \\feedback, 0.98, \\out, 0, \\auxOut, 0, \\auxAmp, 0));"})
}),
s("delay", {
		t({"Ndef(\\"}),
		i(1, "delay"),
		t({", Pbind(\\instrument, \\delay, \\in, 0, \\amp, 0.2, \\delayTime, 1.0, \\delayTimeLag, 3, \\delayDecay, 6, \\out, 0, \\auxOut, 0, \\auxAmp, 0));"})
}),
s("delay", {
    t({"Ndef(\\"}),
    i(1, "delay"),
    t({", Pbind(\\instrument, \\delay, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\delayTime, 1.0, \\delayTimeLag, 3, \\delayDecay, 6));"})
}),
s("dfm1", {
    t({"Ndef(\\"}),
    i(1, "dfm1"),
    t({", Pbind(\\instrument, \\dfm1, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\freq, "}),
    i(2, "1000.0"),
...
s("master", {
    t({"Ndef(\\"}),
    i(1, "master"),
    t({", Pbind(\\instrument, \\master, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\thresh, 0.5, \\slopeBelow, 1.0, \\slopeAbove, 1.0, \\clampTime, 0.01, \\relaxTime, 0.1));"})
}),
s("efKick", {
    t({"Ndef(\\"}),
    i(1, "efKick"),
    t({", Pbind(\\instrument, \\efKick, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\freqA, 800, \\freqB, 50, \\freqC, 40, \\freqDur1, 0.02, \\freqDur2, 0.5, \\freqC1, -3, \\freqC2, -1, \\att, 0.02, \\rel, 2, \\attCrv, 1, \\relCrv, -12, \\pan, 0));"})
}),
s("wt", {
    t({"Ndef(\\"}),
    i(1, "wt"),
    t({", Pbind(\\instrument, \\wt, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\wt, 0, \\inamp, 1));"})
}),
s("noiseSweep", {
    t({"Ndef(\\"}),
    i(1, "noiseSweep"),
...
s("glide", {
    t({"Ndef(\\"}),
    i(1, "glide"),
    t({", Pbind(\\instrument, \\glide, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\freq, "}),
    i(2, "440"),
...
s("blip", {
    t({"Ndef(\\",}),
    i(1, "blip"),
    t({", Pbind(\\instrument, \\blip, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\freq, "}),
    i(2, "440"),
...
s("syncBasic", {
    t({"Ndef(\\",}),
    i(1, "syncBasic"),
    t({", Pbind(\\instrument, \\syncBasic, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\syncFreq, "}),
    i(2, "440"),
...
s("syncSaw", {
    t({"Ndef(\\",}),
    i(1, "syncSaw"),
    t({", Pbind(\\instrument, \\syncSaw, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\syncFreq, "}),
    i(2, "440"),
...
s("klang", {
    t({"Ndef(\\",}),
    i(1, "klang"),
    t({", Pbind(\\instrument, \\klang, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\freq, "}),
    i(2, "800"),
...
s("klangFilter", {
    t({"Ndef(\\",}),
    i(1, "klangFilter"),
    t({", Pbind(\\instrument, \\klangFilter, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\freq, "}),
    i(2, "800"),
...
s("input", {
    t({"Ndef(\\",}),
    i(1, "input"),
    t({", Pbind(\\instrument, \\input, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\dur, 1, \\in, 0, \\out, 0));"})
}),
s("samp", {
    t({"Ndef(\\",}),
    i(1, "samp"),
    t({", Pbind(\\instrument, \\samp, \\amp, 0.2, \\auxOut, 0, \\auxAmp, -30, \\dur, 1, \\buf, 0, \\rate, 1, \\spos, 0, \\att, 0, \\sus, 0.1, \\rel, 0, \\pan, 0));"})
}),
s("fbDelay", {
    t({"Ndef(\\",}),
    i(1, "fbDelay"),
    t({", Pbind(\\instrument, \\fbDelay, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0.5, \\delayTime, 1.0, \\delayTimeLag, 3, \\delayDecay, 6));"})
}),
s("infinity", {
    t({"Ndef(\\",}),
    i(1, "infinity"),
    t({", Pbind(\\instrument, \\infinity, \\feedback, 1));"})
}),
s("vosc", {
    t({"Ndef(\\",}),
    i(1, "vosc"),
    t({", Pbind(\\instrument, \\vosc, \\amp, 0.2, \\auxOut, 0, \\auxAmp, 0, \\detune, 0.2, \\numBufs, 2, \\freq, "}),
    i(2, "300"),
...
s("granMic", {
    t({"Ndef(\\",}),
    i(1, "granMic"),
    t({", Pbind(\\instrument, \\granMic, \\amp, 0.2, \\in, 0));"})
}),
s("granPointer", {
    t({"Ndef(\\",}),
    i(1, "granPointer"),
    t({", Pbind(\\instrument, \\granPointer, \\rate, 1, \\buf, 0));"})
}),
s("gran", {
    t({"Ndef(\\",}),
    i(1, "gran"),
    t({", Pbind(\\instrument, \\gran, \\amp, 0.5, \\bufL, 0, \\bufR, 0, \\att, 1, \\rel, 1, \\gate, 1, \\sync, 1, \\dens, 40, \\baseDur, 0.05, \\durRand, 1, \\rate, 1, \\rateRand, 1, \\pan, 0, \\panRand, 0, \\grainEnv, -1, \\ptrBus, 0, \\ptrSampleDelay, 20000, \\ptrRandSamples, 5000, \\minPtrDelay, 1000));"})
}),
s("granRec", {
    t({"Ndef(\\",}),
    i(1, "granRec"),
