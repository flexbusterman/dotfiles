...
Keybindings = {
    ...
    ["P"]            = COMMAND_FIRE,    -- function() command.fire() end,
    ["SHIFT+P"]      = COMMAND_ALTFIRE, -- function() command.fire( true ) end,
    ["R"]            = function() command.reload() end,
    ["SHIFT+R"]      = function() command.reload( true ) end,
    -- ["U"]            = COMMAND_USE,
    ["SHIFT+U"]      = COMMAND_USE,
    ["Q"]      = function() command.quit() end,
...
--	F9        = function() command.screenshot( true ) end,-- currently hardcoded
    ...
    ["M"]      = function() command.messages() end,
