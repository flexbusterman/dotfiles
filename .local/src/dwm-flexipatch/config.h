...
static const char *altbarclass           = "dwmblocks"; /* Alternate bar class name */
static const char *altbarcmd             = "$HOME/.local/src/dwmblocks/dwmblocks"; /* Alternate bar launch command */
...
#if BAR_PANGO_PATCH
static const char font[]                 = "Px437 Nix8810 M35:size=7:antialias=true:autohint=true";
#else
static const char *fonts[]               = { "Px437 Nix8810 M35:size=7:antialias=true:autohint=true" };
#endif // BAR_PANGO_PATCH
// static const char dmenufont[]            = "monospace:size=10";
static const char dmenufont[]            = "Px437 Nix8810 M35:size=7:antialias=true:autohint=true";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,							XK_s,											spawn,					 	SHCMD("st -e sc-im") },
  ...
  { MODKEY|ControlMask|ShiftMask,	XK_period,								spawn,					 	SHCMD("brave") },
  ...
  { ShiftMask,										XK_Print,									spawn,					 	SHCMD("maim -f jpg -m 9 -s \"/home/flex/Pictures/SCREENSHOTS/$(date +\"%F %H_%M_%S.jpg\")\"")},
	{ MODKEY|ShiftMask,							XK_Up,         						spawn,					 	SHCMD("xdotool keydown --clearmodifiers w")},
	{ MODKEY|ShiftMask,							XK_Down,         					spawn,					 	SHCMD("xdotool keydown shift w")},
	// Flexipatch bindings
	/* modifier                     key            function                argument */
	#if KEYMODES_PATCH
