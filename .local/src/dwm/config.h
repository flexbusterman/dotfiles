...
static const char *fonts[]          = { "Ac437 CompaqThin 8x8:size=8:antialias=true:autohint=true"};
static char dmenufont[]             = "Ac437 CompaqThin 8x8:size=8:antialias=true:autohint=true";
