...
static const char *fonts[]          = { "Px437 IBM BIOS:size=8:antialias=true:autohint=true"};
static char dmenufont[]             = "Px437 IBM BIOS:size=8:antialias=true:autohint=true";
...
static Key keys[] = {
  ...
  /* { MODKEY|ShiftMask,                       XK_comma, spawn,  SHCMD("st env SHELL=/bin/bash vifm")}, */
	{ MODKEY|ShiftMask,    XK_comma, spawn,  SHCMD("st -e ranger ~/Dropbox/ ~/Downloads/")},
