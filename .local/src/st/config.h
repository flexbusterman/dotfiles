...
static char *font = "Ac437 IBM BIOS:size=9:antialias=true:autohint=true";
/* static char *font2[] = { "RobotoMono:pixelsize=17:antialias=true:autohint=true" }; */
static char *font2[] = { "Ac437 IBM BIOS:size=9:antialias=true:autohint=true" };
